...
local function create_glacial_start_locations(world, is_ice_age)
	...
	-- 	end
	-- end)
	for _ in pairs(glacial_seed_table) do
		count = count + 1
	end
	print("Glacial Seeds: " .. count)
end
...
local function find_glacial_perimeter(world)
	...
	-- world:for_each_tile_by_elevation_for_waterflow(function(ti)
	...
	local count = 0
	for _ in pairs(old_layer) do
		count = count + 1
	end
	print("Old Layer: " .. count)
end
