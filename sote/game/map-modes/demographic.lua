...
function dem.population()
	ut.simple_hue_map_mode(function(tile)
		...
		return math.min(1, t.province:local_population() / 100)
	end)
end
...
function dem.population_1000()
	ut.simple_hue_map_mode(function(tile)
		...
		local t = tile
		if (t.province.size == 0) then return 0 end
		return math.min(1, t.province:local_population() / 1000)
	end)
end
...
function dem.population_density()
	ut.simple_hue_map_mode(function(tile)
		...
		local t = tile
		if (t.province.size == 0) then return 0 end
		return math.min(1, math.max(0, t.province:local_population() - 10) / t.province.size)
	end)
end
