...
function d.load()
	...
	ProductionMethod:new {
		...
		g = 1,
		b = 0.1,
		outputs = { ["berries"] = 0.25, ["grain"] = 0.25, ["timber"] = 0.125 },
	...
	ProductionMethod:new {
		...
		g = 1,
		b = 0.1,
		inputs = { ["tools-like"] = 0.0625 },
		outputs = { ["berries"] = 0.33, ["grain"] = 0.33, ["timber"] = 0.1875 },
		jobs = { [job("gatherers")] = 1 },
		job_type = JOBTYPE.FORAGER,
		self_sourcing_fraction = 0.05,
		foraging = true,
	...
	ProductionMethod:new {
		...
		b = 0.1,
		inputs = { ["tools"] = 0.0625 },
		outputs = { ["berries"] = 0.5, ["grain"] = 0.5, ["timber"] = 0.25 },
		jobs = { [job("gatherers")] = 1 },
		job_type = JOBTYPE.FORAGER,
		self_sourcing_fraction = 0.05,
		foraging = true,
	...
	ProductionMethod:new {
		...
		g = 1,
		b = 0.1,
		inputs = { ["blanks-core"] = 1 / 16 }, -- one blank serves for 16 months - made up value
		outputs = { ["tools-blanks"] = 0.25 },
		jobs = { [job("knappers")] = 1 },
