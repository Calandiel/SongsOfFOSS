...
function d.load()
	...
	ProductionMethod:new {
		...
		g = 1,
		b = 0.1,
		outputs = { ["berries"] = 0.125, ["grain"] = 0.125, ["timber"] = 0.0625 },
	...
	ProductionMethod:new {
		...
		outputs = { ["berries"] = 0.2, ["grain"] = 0.2, ["timber"] = 0.1 },
		jobs = { [job("gatherers")] = 1 },
		job_type = JOBTYPE.FORAGER,
		self_sourcing_fraction = 0.05,
		foraging = true,
