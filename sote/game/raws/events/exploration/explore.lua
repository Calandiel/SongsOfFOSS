...
return function()
	...
	Event:new {
		...
		options = function(self, character, associated_data)
			...
			local food_price = economic_values.get_local_price_of_use(associated_data.explored_province, 'food')
			...
			return {
...

				{
					...
					viable = function ()
						local result, _ = economic_triggers.can_buy_use(character, 'food', 1)
						return result
					end,
					outcome = function ()
						economic_effects.buy_use(character, 'food', 1)
