...
function ll.load()
	...
	Decision.Realm:new {
		...
		available = function(root, primary_target)
			...
			---@type Province
			local primary_target = primary_target
			local pop = primary_target:total_population()
		...
		effect = function(root, primary_target, secondary_target)
			...
			economic_effects.change_treasury(root, -primary_target:total_population() * gift_cost_per_pop, economic_effects.reasons.Donation)
