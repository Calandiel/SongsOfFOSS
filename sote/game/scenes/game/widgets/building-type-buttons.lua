...
local function construction_button(gam, rect, building_type, tile, owner, overseer, public_flag)
...
---@param building_type BuildingType
---@param tile Tile
function btb.building_type_buttons(gam, rect, building_type, tile)
